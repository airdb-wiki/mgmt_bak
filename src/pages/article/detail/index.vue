  ...
  <view>
    ...
    <view class="row_container">
        ...
        <view class="row_item border">
            ...
            <view class="value"><text>{{ item.gender==2?'女':'男' }}</text></view>
        </view>
        <view class="row_item border">
            <view class="label"><text>出生日期：</text></view>
            <view class="value"><text>{{ParseTime(item.missed_at,'{y}-{m}-{d}')}}</text></view>
        </view>
        <view class="row_item border">
            <view class="label"><text>寻亲编号：</text></view>
            <view class="value"><text>{{item.babyid}}</text></view>
        </view>
        <view class="row_item border">
            <view class="label"><text>寻亲类别：</text></view>
            <view class="value"><text>{{item.category}}</text></view>
        </view>
        <view class="row_item border">
            <view class="label"><text>户籍地点：{{item.missed_province}}-{{item.missed_city}}-{{item.missed_address}}</text></view>
        </view>
    </view>
    <view class="photos_container">
        <view class="photos_list">
            <view class="photo_item" :key="index" v-for="(photo,index) in item.images">
                <image :src="photo" mode="scaleToFill" class="photo" 
    ...
    <view class="row_container">
        ...
        <view class="row_item border">
            ...
            <view class="value"><text>{{item.data_from}}</text></view>
        </view>
        <view class="row_item border">
            <view class="label"><text>跟进志愿者：</text></view>
            <view class="value"><text>{{item.details}}</text></view>
        </view>
    </view>
